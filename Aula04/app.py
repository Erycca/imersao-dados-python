...
with st.sidebar.expander("Perfil profissional", expanded=False):
...
st.caption("Análise interativa de salários na área de dados com filtros dinâmicos.")
...
with col_graf1:
    if not df_filtrado.empty:
        ...
        grafico_cargos = px.bar(
            ...
            color_discrete_sequence=["#6096ba"]
        )
        grafico_cargos.update_layout(
                paper_bgcolor="#3e5c76",
                plot_bgcolor="#3e5c76",
                font_color="#003249",
                title_x=0.1
         )
...
with col_graf3:
    if not df_filtrado.empty:
        ...
        grafico_remoto = px.pie(
            ...
            hole=0.5,
            color_discrete_sequence=["#6096ba", "#5e60ce", "#7400b8"]
        )
